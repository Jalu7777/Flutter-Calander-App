...
Future<Database>initialDatabase()async{
  ...
  var db=await openDatabase(path,version: 3,onCreate: onCreate);
  return db;
}

onCreate(Database db,int version)async{
await db.execute('CREATE TABLE $table ($id INTEGER PRIMARY KEY AUTOINCREMENT,$title TEXT,$fromDate TEXT,$toDate TEXT,$background TEXT,$colorTitle TEXT)');
}
